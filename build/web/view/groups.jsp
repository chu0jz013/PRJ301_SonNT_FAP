...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center;">VIEW GROUP MEMBERS</h1>
        <div>
            <h2>SEMESTER:
            ...
            <h2>GROUPS:
                <c:forEach var="g" items="${requestScope.groups}">
                    <a style="font-size: small;" href="Groups?semester_id=${sessionScope.semester_id}&group_id=${g.group_id}"">${g.course.course_name} - ${g.group_name}</a>
                </c:forEach>
            </h2>
        </div>
        ...
        <h2 style="text-align: center;" > GROUP:
            <c:forEach var="group" items="${requestScope.groups}">
                <c:if test="${group.group_id == requestScope.group_id}">
                    ${group.group_name} - ${group.course.course_name}
                </c:if>
            </c:forEach>
        </h2>
        <table>

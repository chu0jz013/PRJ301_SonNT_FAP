...
<html>
    ...
    <body>
        ...
        <div>
            <h2 style="text-align: center;">CREATE MAJOR</h2>
            </br>
            <form action="../MajorManagement/add" method="POST" class="form-container"> 
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="major_name" id="major_name" required/>
                </div>
                <div class="form-group">
                    <label for="major_description">Description:</label>
                    <textarea name="major_description" id="major_description" rows="5" cols="40"></textarea>
                </div>
                <div class="form-group">
